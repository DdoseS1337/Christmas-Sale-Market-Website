        ...
        <Container>
            <Row 
                ...
                <Col xs={5}
                    ...
                    <p className="text-body-tertiary">Отримуйте унікальні пропозиції та акції.</p>
                </Col>
                <Col>
                    <FooterInputBar />
                </Col>
            </Row>
            <img className='footer-email-section__tree-icon' src="images/pictures/tree-presents.png" alt="" />
        </Container>
    </div>
  )
}
